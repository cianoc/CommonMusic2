...
This is a fork of a form of CommonMusic2, where I pull out the pieces that I find useful. This will be the core features of events, 
scales, spectral, events and patterns - as everything else has better modern equivalents and I don't want to maintain them.
...
I will also add other stuff that I find useful - and if it deviates sufficiently for CommonMusic then I will probably rename it, 
while keeping the heritage clear.

Internally I plan to remove as much MOP stuff, and use vectors instead of lists.

There will be zero scheduling code. I will probably not bother with the CM/Fomus integration as it feels needlessly complicated.
CM should not need to know about other implementations - instead it should just work in a fairly standard way. At least that's the dream.
